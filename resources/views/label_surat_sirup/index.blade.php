    ...
    <div class="card card-body mb-5">
        ...
        <form id="form-filter">
            ...
            <div class="text-right">
                <a href="#" class="btn btn-secondary font-italic font-weight-bold">Kembali</a>
        ...
        <form class="form_default" method="POST" action="{{url('label-surat-sirup/buat-label')}}" target="_blank">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <button class="btn btn-secondary btn-lg btn-block font-weight-bolder" name="id_tlpn" type="submit" value="1">Generate Tanpa Nomor Telepon</button>
                </div>
                <div class="col-6 text-right">
                    <button class="btn btn-primary btn-lg btn-block font-weight-bolder" name="id_tlpn" type="submit" value="2">Generate Dengan Nomor Telepon</button>
                </div>
            </div>
        </form>
    </div>
