...
<div class="container-fluid">
    ...
    <div class="card card-custom">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-6">
                    <h4 class="text-primary font-weight-bolder">Edit Data RUP</h4>
                </div>
            </div>
            <hr>


            <form class="form_default" method="POST" action="{{url('rup/proses-edit-import/' . Request::segment(3))}}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="alamat_organisasi" value="{{$rup->alamat_organisasi}}" class="form-control" required="required">
                    </div>
                </div>
                ...
                <div class="text-right mt-5">
                    <a class="btn btn-secondary font-weight-bold" href="{{url('rup/' . Session::get('id_users'))}}">Kembali</a>
