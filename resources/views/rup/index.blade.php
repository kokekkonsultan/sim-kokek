...
<script>
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "{{url('rup/' . Request::segment(2))}}", // memanggil route yang menampilkan data json
                "data": function(d) {
                    d.pic = $('#pic').val(),
                        d.bulan = $('#bulan').val(),
                        d.tahun = $('#tahun').val(),
...
<script>
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    url: "{{url('rup/ubah-ke-prospek')}}/" + id1,
                    dataType: "JSON",
                    beforeSend: function() {
                        Swal.fire({
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "{{url('rup/ubah-ke-tidak-prospek')}}/" + id1,
                    dataType: "JSON",
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Memproses data',
    ...
    function delete_data(id1, id2) {
        Swal.fire({
            ...
            html: "Anda akan menghapus RUP <b>" + id2 + "</b> ?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
