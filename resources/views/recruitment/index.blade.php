...
<div class="container-fluid">
    <div class="card card-custom">
        <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <h2 class="text-primary font-weight-bolder">{{strtoupper($title)}}</h2>
                </div>
            </div>
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">124 Permintaan</div>
                                <div class="fw-bold text-gray-400">Form Permintaan Karyawan</div>
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">80</div>
                                <div class="fw-bold text-gray-100">Permintaan Di Approve</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">44</div>
                                <div class="fw-bold text-white">Permintaan Di Reject</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
