...
<form class="form_default" method="POST" action="{{url('dpb/edit_tanggal_terima_kontrak/' . $dpb->id_dpb)}}">
    @csrf


    <input class="form-control" type="date" name="tanggal_kontrak_diterima" value="{{$dpb->tanggal_kontrak_diterima}}" required>
