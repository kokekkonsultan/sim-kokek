            ...
            <div class="row">
                <div class="col-6">
                    <h4 class="text-primary font-weight-bolder">
                        {{strtoupper('Formulir Informasi Pekerjaan (FIP) Direksi')}}</h4>
                </div>
                <div class="col-6">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form_default" method="GET" action="{{url('fip-direksi/export')}}" target="_blank">
...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "{{url('fip-direksi/' . Request::segment(2))}}", // memanggil route yang menampilkan data json
            "data": function(d) {
                d.tahun = $('#tahun').val(),
...
function showTunjukPIC(id) {
    ...
    $.ajax({
        type: "get",
        url: "{{url('fip-direksi/modal-tunjuk-pic')}}/" + id,
        dataType: "text",
...
function approved(id1, id2) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                type: "GET",
                url: "{{url('fip-direksi/approved')}}/" + id1,
                dataType: "JSON",
                beforeSend: function() {
                    Swal.fire({
