    ...
    <table width="100%" border="0" style="font-family: Arial, Helvetica, sans-serif; font-size:12px;">
        ...
        <tr>
            <td>
                ...
                <p>Diinformasikan, untuk pekerjaan dengan nama paket pekerjaan <b>{{$fip->nama_pekerjaan}}</b> dengan pemberi kerja <b>{{$fip->pemberi_kerja}}</b> dan jangka waktu pekerjaan <b>{{$fip->durasi_kontrak_pekerjaan}}</b> ini <b style="color: #1BC5BD;">telah di cek dan disetujui oleh Direktur.</b></p>
            </td>
        </tr>
        <tr>
            <td>
