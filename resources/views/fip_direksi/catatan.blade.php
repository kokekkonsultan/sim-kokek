    ...
    <div class="card card-body">
        <div class="row">
            ...
            <div class="col-6 text-right">
                <a class="btn btn-secondary font-weight-bold" href="{{url('fip-direksi/' . Session::get('id_users'))}}"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            ...
            <div class="col-6 text-right">
                <a class="btn btn-primary font-weight-bold btn-sm" data-toggle="modal" data-target="#add_catatan"><i
                        class="fa fa-plus"></i> Tambah Catatan Direksi</a>
            </div>
        </div>
        <hr>
...
@include('fip_direksi/modal_add_catatan')
@include('fip_direksi/modal_edit_catatan')
