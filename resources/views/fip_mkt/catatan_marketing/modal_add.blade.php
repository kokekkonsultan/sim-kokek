...
<!-- MODAL ADD BIAYA -->
<div class="modal fade" id="add_catatan_marketing" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Catatan Marketing</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">X</button>
            </div>
            <div class="modal-body">

                <form class="form_default" method="POST" action="{{url('fip-mkt/add-catatan')}}">
                    @csrf

                    <input name="id_fip" value="{{$fip->id_fip}}" hidden>
                    <input name="jenis_catatan" value="1" hidden>
