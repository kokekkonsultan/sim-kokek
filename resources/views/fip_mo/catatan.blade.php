...
<div class="container-fluid">
    ...
    <div class="text-center bg-light-primary mb-5" style="border:2px solid #3699FF; padding: 1em;">
        ...
        <b>Silahkan review data FIP terlebih dahulu atau  <a href="#catatan_mo">langsung beri catatan</a>.</b>
    </div>
    ...
    <div class="card card-body">
        <div class="row">
            ...
            <div class="col-6 text-right">
                <a class="btn btn-secondary font-weight-bold" href="{{url('fip-mo/' . Session::get('id_users'))}}"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <hr>
    ...
    <div class="card card-body mt-5" id="catatan_mo">
        <div class="row">
            <div class="col-6">
            ...
            <div class="col-6 text-right">
                <a class="btn btn-primary font-weight-bold btn-sm" data-toggle="modal" data-target="#add_catatan"><i
                        class="fa fa-plus"></i> Tambah Catatan Manager Operasional</a>
            </div>
        </div>
        <hr>
        ...
        <table class="table table-bordered table-hover example" width="100%">
            ...
            <tr>
                ...
                <th>
                    <a class="btn btn-light-info btn-icon btn-sm" data-toggle="modal" data-target="#edit_catatan_{{$value->id_catatan_fip}}">
...
@include('fip_mo/modal_add_catatan')
@include('fip_mo/modal_edit_catatan')
