...
class FipMoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // date('Y')
        $fipMo = DB::table('view_fip_general_manager');
        if ($request->ajax()) {
                    ...
                    <div class="dropdown dropdown-inline">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            <ul class="navi flex-column navi-hover py-2">
                                ...
                                <li class="navi-item">
                                    <a href="/fip-mo/catatan/' . $row->id_fip . '" class="navi-link" target="_blank">
                                        <span class="navi-icon"><i class="la la-arrow-right"></i></span>
        ...
        return view('fip_mo.index', $this->data);
    ...
    {
        $this->data = [];
        $this->data['fip'] = DB::table('view_fip_general_manager')->where('id_fip', $id)->first();
        // echo $id;

        return view('fip_mo.modal_tunjuk_pic', $this->data);
    }
    ...
    public function approved(Request $request, $id)
    {
        ...
        // return view('fip_mo.approve_email', $this->data);
        Mail::send('fip_mo.approve_email', $this->data, function ($message) use ($fip) {
        ...
        $object = [
			'is_approve_mo'        	=> 1,
			'approve_mo_id'        	=> Session::get('id_users'),
			'approve_mo_at'			=> now()
		];
        DB::table("formulir_informasi_pekerjaan")->where('id_fip', $id)->update($object);
    ...
    public function catatan($id)
    {
        ...
        return view('fip_mo.catatan', $this->data);
    }
    ...
    public function add_catatan(Request $request)
    {
        ...
        return redirect('fip-mo/catatan/' . $request['id_fip']);
    }
    ...
    public function export(Request $request)
    {
        ...
        $this->data['fip'] = DB::table('view_fip_general_manager')->where('tahun_anggaran', $this->data['mulai'])
        ...
        $content = view('fip_mo.export', $this->data);
        $status = 200;
        $headers = [
