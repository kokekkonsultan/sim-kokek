...
class FipAdproController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return Datatables::of($fipMo)
                    ...
                    <div class="dropdown dropdown-inline">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            <ul class="navi flex-column navi-hover py-2">
                                ...
                                <li class="navi-item">
                                    <a href="/fip-adpro/catatan/' . $row->id_fip . '" class="navi-link" target="_blank">
                                        <span class="navi-icon"><i class="la la-arrow-right"></i></span>
                                ...
                                <li class="navi-item">
                                    <a onclick="showTunjukPIC(' . $row->id_fip . ')" href="#modal_tunjuk_pic" data-toggle="modal" class="navi-link">
                                        <span class="navi-icon"><i class="la la-arrow-right"></i></span>
                                        <span class="navi-text">Tunjuk PIC Konsultan</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                ->rawColumns(['kode_fip', 'nama_pekerjaan_fip', 'durasi_kerja', 'tanggal_bast', 'updated', 'acc_oleh'])
        ...
        return view('fip_adpro.index', $this->data);
    ...
    public function modal_tunjuk_pic($id)
    {
        ...
        return view('fip_adpro.modal_tunjuk_pic', $this->data);
    }
    ...
    public function catatan($id)
    {
        ...
        return view('fip_adpro.catatan', $this->data);
    }
    ...
    public function add_catatan(Request $request)
    {
        ...
        return redirect('fip-adpro/catatan/' . $request['id_fip']);
    }
    ...
    public function export(Request $request)
    {
        ...
        $this->data['fip'] = DB::table('view_fip_adpro')->where('tahun_anggaran', $this->data['mulai'])
        ...
        $content = view('fip_adpro.export', $this->data);
        $status = 200;
        $headers = [
