...
class SuratSirup extends TCPDF
{
    public function Header() {

        $this->setJPEGQuality(300);
        $this->Image('assets/img/kop/kc-bsi-logo-2.jpg', 25, 10, 80, 15, 'PNG', 'http://www.kokek.com', '', true, 1000, '', false, false, 0, false, false, false);
		$this->Image('assets/img/kop/arrow-logo.png', 170, 10, 14, 14, 'PNG', 'http://www.kokek.com', '', true, 1000, '', false, false, 0, false, false, false);
